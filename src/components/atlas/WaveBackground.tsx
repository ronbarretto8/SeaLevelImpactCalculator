...
export const WaveBackground = memo(({ variant = "hero", className = "", isDark = true }: WaveBackgroundProps) => {
  ...
  const colors = {
    sky: isDark ? ["hsl(216, 80%, 5%)", "hsl(216, 80%, 3%)"] : ["hsl(205, 50%, 85%)", "hsl(210, 60%, 75%)"],
    back: isDark ? ["hsl(211, 80%, 7%)", "hsl(211, 80%, 4%)"] : ["hsl(205, 60%, 80%)", "hsl(210, 65%, 70%)"],
    azure: isDark ? ["hsl(205, 75%, 10%)", "hsl(205, 75%, 6%)"] : ["hsl(200, 70%, 75%)", "hsl(205, 75%, 65%)"],
    mid: isDark ? ["hsl(201, 70%, 14%)", "hsl(201, 70%, 8%)"] : ["hsl(205, 70%, 70%)", "hsl(210, 75%, 60%)"],
    front: isDark ? ["hsl(199, 70%, 18%)", "hsl(199, 70%, 10%)"] : ["hsl(210, 65%, 65%)", "hsl(214, 70%, 55%)"],
    navy: isDark ? ["hsl(218, 80%, 4%)", "hsl(220, 90%, 2%)"] : ["hsl(214, 70%, 60%)", "hsl(216, 75%, 50%)"],
    foam: isDark ? ["hsl(201, 80%, 15%)", "hsl(201, 80%, 15%)"] : ["hsl(188, 80%, 90%)", "hsl(188, 80%, 90%)"],
  };
