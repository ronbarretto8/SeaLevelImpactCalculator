...
export const WaveBackground = memo(({ variant = "hero", className = "", isDark = true }: WaveBackgroundProps) => {
  ...
  const colors = {
    sky: isDark ? ["hsl(214, 40%, 10%)", "hsl(216, 50%, 5%)"] : ["hsl(205, 50%, 85%)", "hsl(210, 60%, 75%)"],
    back: isDark ? ["hsl(214, 45%, 8%)", "hsl(218, 55%, 4%)"] : ["hsl(205, 60%, 80%)", "hsl(210, 65%, 70%)"],
    azure: isDark ? ["hsl(210, 50%, 12%)", "hsl(214, 60%, 6%)"] : ["hsl(200, 70%, 75%)", "hsl(205, 75%, 65%)"],
    mid: isDark ? ["hsl(212, 55%, 10%)", "hsl(216, 65%, 5%)"] : ["hsl(205, 70%, 70%)", "hsl(210, 75%, 60%)"],
    front: isDark ? ["hsl(216, 60%, 8%)", "hsl(218, 70%, 4%)"] : ["hsl(210, 65%, 65%)", "hsl(214, 70%, 55%)"],
    navy: isDark ? ["hsl(218, 70%, 5%)", "hsl(220, 80%, 3%)"] : ["hsl(214, 70%, 60%)", "hsl(216, 75%, 50%)"],
    foam: isDark ? ["hsl(200, 100%, 30%)", "hsl(200, 100%, 30%)"] : ["hsl(188, 80%, 90%)", "hsl(188, 80%, 90%)"],
  };
