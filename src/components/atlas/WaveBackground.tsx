...
export const WaveBackground = memo(({ variant = "hero", className = "", isDark = true }: WaveBackgroundProps) => {
  ...
  const colors = {
    sky: isDark ? ["hsl(214, 60%, 5%)", "hsl(216, 70%, 2%)"] : ["hsl(205, 50%, 85%)", "hsl(210, 60%, 75%)"],
    back: isDark ? ["hsl(214, 55%, 4%)", "hsl(218, 65%, 2%)"] : ["hsl(205, 60%, 80%)", "hsl(210, 65%, 70%)"],
    azure: isDark ? ["hsl(210, 60%, 6%)", "hsl(214, 70%, 3%)"] : ["hsl(200, 70%, 75%)", "hsl(205, 75%, 65%)"],
    mid: isDark ? ["hsl(212, 65%, 5%)", "hsl(216, 75%, 2%)"] : ["hsl(205, 70%, 70%)", "hsl(210, 75%, 60%)"],
    front: isDark ? ["hsl(216, 70%, 4%)", "hsl(218, 80%, 2%)"] : ["hsl(210, 65%, 65%)", "hsl(214, 70%, 55%)"],
    navy: isDark ? ["hsl(218, 80%, 3%)", "hsl(220, 90%, 1%)"] : ["hsl(214, 70%, 60%)", "hsl(216, 75%, 50%)"],
    foam: isDark ? ["hsl(190, 100%, 8%)", "hsl(190, 100%, 8%)"] : ["hsl(188, 80%, 90%)", "hsl(188, 80%, 90%)"],
  };
